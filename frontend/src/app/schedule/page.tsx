...
export default function SchedulePage() {
  ...
  const filteredAndSortedSections = useMemo(() => {
    const defaultCatalog = [
      ...
      { id: 6, name: "II AIML-F", year: "II", branch: "AIML" },
      { id: 7, name: "II AIML-G", year: "II", branch: "AIML" },
      { id: 8, name: "II AIML-H", year: "II", branch: "AIML" },
      { id: 9, name: "II AIML-I", year: "II", branch: "AIML" },
      { id: 10, name: "II AIML-J", year: "II", branch: "AIML" },
      { id: 11, name: "II AIML-K", year: "II", branch: "AIML" },
      { id: 12, name: "II AIML-L", year: "II", branch: "AIML" },
      { id: 13, name: "III AIML-A", year: "III", branch: "AIML" },
      { id: 14, name: "III AIML-B", year: "III", branch: "AIML" },
      { id: 15, name: "III AIML-C", year: "III", branch: "AIML" },
      { id: 16, name: "III AIML-D", year: "III", branch: "AIML" },
      { id: 17, name: "III AIML-E", year: "III", branch: "AIML" },
      { id: 18, name: "III AIML-F", year: "III", branch: "AIML" },
      { id: 19, name: "III AIML-G", year: "III", branch: "AIML" },
      { id: 20, name: "IV AIML-A", year: "IV", branch: "AIML" },
      { id: 21, name: "IV AIML-B", year: "IV", branch: "AIML" },
      { id: 22, name: "IV AIML-C", year: "IV", branch: "AIML" },
      { id: 23, name: "IV AIML-D", year: "IV", branch: "AIML" },
      { id: 24, name: "IV AIML-E", year: "IV", branch: "AIML" },
      { id: 25, name: "II BS(DS)", year: "II", branch: "BS(DS)" },
      { id: 26, name: "III BS(DS)", year: "III", branch: "BS(DS)" },
      { id: 27, name: "II CS-A", year: "II", branch: "CS" },
      { id: 28, name: "II CS-B", year: "II", branch: "CS" },
      { id: 29, name: "III CS", year: "III", branch: "CS" },
      { id: 30, name: "IV CS", year: "IV", branch: "CS" },
      { id: 31, name: "II CSBS", year: "II", branch: "CSBS" },
      { id: 32, name: "III CSBS", year: "III", branch: "CSBS" },
      { id: 33, name: "IV - CSBS", year: "IV", branch: "CSBS" },
      { id: 34, name: "II DS-A", year: "II", branch: "DS" },
      { id: 35, name: "II DS-B", year: "II", branch: "DS" },
      { id: 36, name: "III DS-A", year: "III", branch: "DS" },
      { id: 37, name: "III DS-B", year: "III", branch: "DS" },
      { id: 38, name: "IV DS", year: "IV", branch: "DS" },
      { id: 39, name: "II IOT", year: "II", branch: "IOT" },
      { id: 40, name: "III IOT", year: "III", branch: "IOT" },
      { id: 41, name: "II MSC (DS)", year: "II", branch: "MSC(DS)" },
      { id: 42, name: "sec1", year: "IV", branch: "CS" },
      { id: 43, name: "sec2", year: "IV", branch: "CS" },
      { id: 44, name: "sec3", year: "IV", branch: "CS" },
      { id: 45, name: "sec4", year: "IV", branch: "CS" },
      { id: 46, name: "sec5", year: "IV", branch: "CS" },
      { id: 47, name: "sec6", year: "IV", branch: "CS" },
      { id: 48, name: "sec7", year: "IV", branch: "CS" },
      { id: 49, name: "sec8", year: "IV", branch: "CS" },
      { id: 50, name: "sec9", year: "IV", branch: "CS" },
      { id: 51, name: "sec10", year: "IV", branch: "CS" },
      { id: 52, name: "sec11", year: "IV", branch: "CS" },
      { id: 53, name: "sec12", year: "IV", branch: "CS" },
      { id: 54, name: "sec13", year: "IV", branch: "CS" },
      { id: 55, name: "sec14", year: "IV", branch: "CS" },
      { id: 56, name: "sec15", year: "IV", branch: "CS" },
      { id: 57, name: "sec16", year: "IV", branch: "CS" },
      { id: 58, name: "sec17", year: "IV", branch: "CS" },
      { id: 59, name: "sec18", year: "IV", branch: "CS" },
      { id: 60, name: "sec19", year: "IV", branch: "CS" },
    ];
