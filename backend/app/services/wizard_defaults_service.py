    ...
    async def get_wizard_defaults(db: Optional[AsyncSession] = None) -> Dict[str, Any]:
        ...
        curricula = {
            "II Year": [
                ...
                {"subject_code": "LIBRARY", "subject_name": "Central Library Session", "subject_type": "LIBRARY", "faculty_name": "Library Staff", "co_faculty": [], "weekly_hours": 1, "continuous_slots": 1},
                {"subject_code": "IIC", "subject_name": "Agentic AI Tools (Industry-Integrated Course)", "subject_type": "IIC", "faculty_name": "Industry Specialist", "co_faculty": [], "weekly_hours": 1, "continuous_slots": 1},
            ],
            "III Year": [
                {"subject_code": "QALR", "subject_name": "Quantitative Aptitude & Logical Reasoning", "subject_type": "L", "faculty_name": "Training Specialist", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                ...
                {"subject_code": "IDP", "subject_name": "Inter Departmental Project / Agentic Tools", "subject_type": "L", "faculty_name": "Project Coordinator", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "ADS", "subject_name": "Advanced Data Structures (DE-1)", "subject_type": "L", "faculty_name": "Dr. B. Sudha Rani", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "CV", "subject_name": "Computer Vision (DE-2)", "subject_type": "L", "faculty_name": "Dr. Arnab Dey", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                ...
                {"subject_code": "MINORS/HONORS", "subject_name": "Synchronized Minors / Honors Track", "subject_type": "MINORHONOR", "faculty_name": "A. Hruday Raj", "co_faculty": ["Ms. Attuluri Ramya"], "weekly_hours": 4, "continuous_slots": 2},
            ],
            "IV Year": [
                {"subject_code": "SL/EL", "subject_name": "Self Learning / Experiential Learning", "subject_type": "SL_EL", "faculty_name": "Self-Guided", "co_faculty": [], "weekly_hours": 12, "continuous_slots": 2},
                {"subject_code": "KRR", "subject_name": "Knowledge Representation & Reasoning", "subject_type": "L", "faculty_name": "Dr. Jawad Ahmad Dar", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "TM", "subject_name": "Text Mining", "subject_type": "L", "faculty_name": "Dr. B. Jyostna Devi", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "TM(P)", "subject_name": "Text Mining Lab", "subject_type": "P", "faculty_name": "Dr. B. Jyostna Devi", "co_faculty": ["Dr. Fathimabi Shaik", "MAIDUKURI VIJAYALAKSHMI"], "weekly_hours": 2, "continuous_slots": 2},
                {"subject_code": "CNS", "subject_name": "Cryptography & Network Security", "subject_type": "L", "faculty_name": "Dr. Guttikonda Prashanti", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "CNS(P)", "subject_name": "Cryptography Lab", "subject_type": "P", "faculty_name": "Dr. Guttikonda Prashanti", "co_faculty": ["P. Girija", "Ms. Jayamma Rodda"], "weekly_hours": 2, "continuous_slots": 2},
                {"subject_code": "Ethics-AI", "subject_name": "Ethics in Computing & AI", "subject_type": "L", "faculty_name": "Dr. A.V. Nageswara Rao", "co_faculty": [], "weekly_hours": 2, "continuous_slots": 1},
                {"subject_code": "GENAI", "subject_name": "Generative AI & Agentic Systems", "subject_type": "L", "faculty_name": "Kuchipudi. koushika", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "GENAI(P)", "subject_name": "Generative AI Practical Lab", "subject_type": "P", "faculty_name": "Kuchipudi. koushika", "co_faculty": ["V. Amarnath", "Mr. Mahendra Varma"], "weekly_hours": 2, "continuous_slots": 2},
                {"subject_code": "IOT", "subject_name": "Internet of Things", "subject_type": "L", "faculty_name": "Dr. K. Lova Raju", "co_faculty": [], "weekly_hours": 3, "continuous_slots": 1},
                {"subject_code": "IOT(P)", "subject_name": "Internet of Things Lab", "subject_type": "P", "faculty_name": "Dr. K. Lova Raju", "co_faculty": ["Ms. G. Jyostna"], "weekly_hours": 2, "continuous_slots": 2},
                {"subject_code": "MINORS/HONORS", "subject_name": "Synchronized Minors / Honors Track", "subject_type": "MINORHONOR", "faculty_name": "Department Faculty", "co_faculty": [], "weekly_hours": 4, "continuous_slots": 2},
            ],
        }
